...
function addTwoNumbers() {
    ...
    const val1 = firstInput.value;
    const val2 = secondInput.value;
...
function displayCart() {
    ...
    const displayItem = (item) => {
        const price = item.getAttribute("data-price"); // attribute data-price
        const quantity = myCart[item.id]; // stored in myCart
